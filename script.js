...
function changeModel(){
    ...
    //if (modelName.innerHTML == "Model XYZ"){
        //modelName = "CPRG";
    if (model_text.innerHTML == "Model XYZ"){
    ...
    */
    ...
    function changeDuration(){
        ...
        let enter_duration = prompt("Enter duration");
        //let duration = parseInt(enter_duration);
    
        duration_text.innerHTML = enter_duration;
        recalculate();
    }
